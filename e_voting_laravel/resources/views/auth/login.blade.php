    ...
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <div class="text-center mb-3">
          <a href="/">
            <img src="{{config('app.logo')}}" width="80%" alt="">
          </a>
        </div>
        <form class="card card-md" action="{{route('login_process')}}" method="post">
          @csrf
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Login to your account</h2>
            <div class="mb-3">
              <label class="form-label">Email/Username/NIK</label>
              <input type="text" name="login" class="form-control" placeholder="Enter email, username or NIK">
            </div>
            <div class="mb-2">
        ...
        <div class="text-center text-muted mt-3">
          Daftar sebagai calon bupati atau wakil? <a href="{{url('calon/pendaftaran')}}">klik disini</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
